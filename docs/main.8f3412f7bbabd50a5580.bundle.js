...
`;TextInput.displayName="TextInput",exports.default=TextInput},255:function(module,exports,__webpack_require__){"use strict";(function(module){var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const React=__importStar(__webpack_require__(0)),styled_components_1=__importDefault(__webpack_require__(9)),react_1=__webpack_require__(7),alert_1=__importDefault(__webpack_require__(256)),logo_png_1=__importDefault(__webpack_require__(515)),Title=styled_components_1.default.h1`
  color: #212121;
  text-align: center;
  padding-bottom: 20px;
  margin-bottom: 20px;
...
`;Pill.displayName="Pill",exports.default=Pill},269:function(module,exports,__webpack_require__){"use strict";var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};function getSwitchColor(props){return props.on?props.theme.colors.main:props.theme.colors.secondary}Object.defineProperty(exports,"__esModule",{value:!0});const Switch=__importDefault(__webpack_require__(9)).default.button`
  height: 1em;
  width: 2.5em;
...
`;ButtonGroup.displayName="ButtonGroup",exports.default=ButtonGroup},590:function(module,exports,__webpack_require__){"use strict";(function(module){var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const React=__importStar(__webpack_require__(0)),react_1=__webpack_require__(7),addon_actions_1=__webpack_require__(39),checkbox_1=__importDefault(__webpack_require__(591)),DemoStateWrapper=({render:render,initialValue:initialValue})=>{const[checked,setChecked]=React.useState(initialValue||!1);return render(checked,()=>{setChecked(!checked),addon_actions_1.action("click")(checked?"unchecked":"checked")})};react_1.storiesOf("Checkbox",module).add("Default",()=>React.createElement(DemoStateWrapper,{render:(checked,onClick)=>React.createElement(checkbox_1.default,{checked:checked,onClick:onClick})})).add("Disabled",()=>React.createElement("div",null,React.createElement(checkbox_1.default,{disabled:!0,onClick:addon_actions_1.action("clicked")}),React.createElement("br",null),React.createElement(checkbox_1.default,{disabled:!0,checked:!0,onClick:addon_actions_1.action("clicked")})))}).call(this,__webpack_require__(4)(module))},591:function(module,exports,__webpack_require__){"use strict";var __importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const polished_1=__webpack_require__(58);function getBorderColor(props){return props.checked?props.theme.colors.main:props.theme.colors.secondary}const Checkbox=__importDefault(__webpack_require__(9)).default.button`
  border-radius: 1em;
...
`;Checkbox.displayName="Checkbox",exports.default=Checkbox},592:function(module,exports,__webpack_require__){"use strict";(function(module){var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const React=__importStar(__webpack_require__(0)),react_1=__webpack_require__(7),addon_actions_1=__webpack_require__(39),formSection_1=__importDefault(__webpack_require__(593)),textInput_1=__importDefault(__webpack_require__(122)),DemoStateWrapper=({render:render,initialValue:initialValue})=>{const[text,setText]=React.useState(initialValue||"");return render(text,({target:target})=>{setText(target.value),addon_actions_1.action("change")(target.value)})};react_1.storiesOf("FormSection",module).add("Default",()=>React.createElement("div",null,React.createElement(formSection_1.default,{title:"Name"},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange})})),React.createElement(formSection_1.default,{title:"Email Address"},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange})})))).add("Required",()=>React.createElement("div",null,React.createElement(formSection_1.default,{title:"Name",required:!0},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange})})),React.createElement(formSection_1.default,{title:"Email Address"},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange})})))).add("Error",()=>React.createElement("div",null,React.createElement(formSection_1.default,{title:"Name",required:!0,error:"Please enter your name"},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange,error:!0})})),React.createElement(formSection_1.default,{title:"Email Address"},React.createElement(DemoStateWrapper,{render:(text,onChange)=>React.createElement(textInput_1.default,{value:text,onChange:onChange})}))))}).call(this,__webpack_require__(4)(module))},593:function(module,exports,__webpack_require__){"use strict";var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const React=__importStar(__webpack_require__(0)),styled_components_1=__importDefault(__webpack_require__(9)),SectionTitle=styled_components_1.default.div`
  font-size: 1em;
  margin-bottom: 5px;
  font-weight: 600;
...
`;ProgressBar.displayName="ProgressBar",exports.default=ProgressBar},606:function(module,exports,__webpack_require__){"use strict";(function(module){var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const React=__importStar(__webpack_require__(0)),react_1=__webpack_require__(7),addon_actions_1=__webpack_require__(39),select_1=__importDefault(__webpack_require__(607)),choices=[{value:"choice1",text:"Choice 1"},{value:"choice2",text:"Choice 2"},{value:"choice3",text:"Choice 3"}],DemoStateWrapper=({render:render,initialValue:initialValue})=>{const[value,setValue]=React.useState(initialValue||choices[0].value);return render(value,newValue=>{setValue(newValue),addon_actions_1.action("select")(newValue)})};react_1.storiesOf("Select",module).add("Default",()=>React.createElement("div",null,React.createElement(DemoStateWrapper,{render:(value,onSelect)=>React.createElement(select_1.default,{onSelect:onSelect,choices:choices,value:value})}),React.createElement(DemoStateWrapper,{render:(value,onSelect)=>React.createElement(select_1.default,{onSelect:onSelect,choices:choices,value:value,color:"secondary"})}))).add("Disabled",()=>React.createElement("div",null,React.createElement(select_1.default,{onSelect:addon_actions_1.action("select"),choices:choices,value:"choice1",disabled:!0}),React.createElement(select_1.default,{onSelect:addon_actions_1.action("select"),choices:choices,value:"choice1",color:"secondary",disabled:!0})))}).call(this,__webpack_require__(4)(module))},607:function(module,exports,__webpack_require__){"use strict";var __importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)Object.hasOwnProperty.call(mod,k)&&(result[k]=mod[k]);return result.default=mod,result},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const polished_1=__webpack_require__(58),React=__importStar(__webpack_require__(0)),styled_components_1=__importDefault(__webpack_require__(9)),button_1=__importDefault(__webpack_require__(87)),DEFAULT_COLOR="main";const SelectMenuRow=styled_components_1.default.button`
  background-color: ${props=>props.theme.colors.white};
  padding: 0.75em 1em;
  margin: 5px 0;
  display: block;
...
//# sourceMappingURL=main.8f3412f7bbabd50a5580.bundle.js.map